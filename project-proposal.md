...
| FRED Economic Data (St. Louis Fed) \[6\] | JSON (REST API) | Monthly time series | Federal Funds Rate (FEDFUNDS), Prime Rate (MPRIME), CPI (CPIAUCSL), Unemployment (UNRATE) | Join to SBA loans by approval year/month as macroeconomic controls |
